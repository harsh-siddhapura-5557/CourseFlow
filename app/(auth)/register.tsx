        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }} className="p-6">
          <View className="flex-1 justify-center">
            <View className="mb-10">
              <Text className="text-4xl font-bold text-text mb-2">Join Now</Text>
              <Text className="text-muted text-lg">Create an account to start learning</Text>
            </View>

            <View className="space-y-4">
              <View>
                <Text className="text-text font-semibold mb-2 ml-1">Username</Text>
                <TextInput
